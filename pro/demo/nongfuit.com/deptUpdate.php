		...
		&nbsp;
				...
				部门名称
						...
						<td align="left" class="txlHeaderBackgroundAlternate">
								<input type="text" name="dName" value="<?php echo $rs["dName"];?>"></td>
								</tr>
								<tr align="center" bgcolor="#799AE1">
                <td align="right" class="txlHeaderBackgroundAlternate">
                部门负责人
                		...
                		<td align="left" class="txlHeaderBackgroundAlternate">
                <input type="text" name="dMan" value="<?php echo $rs["dMan"];?>">
                </td>
                 
                </tr> <tr align="center" bgcolor="#799AE1">
                <td align="right" class="txlHeaderBackgroundAlternate">
                部门负责人电话
                </td>
                		<td align="left" class="txlHeaderBackgroundAlternate">
                				<input type="text" name="dManTel" value="<?php echo $rs["dManTel"];?>">
                				</td>
                    ...
                    部门职能介绍
                    		...
                    		<td align="left" class="txlHeaderBackgroundAlternate">
                    		<textarea rows="8" cols="60" name="dInfo"><?php echo $rs["dInfo"];?>
                    		</textarea>
                    				</td>
                    				</tr>
                    				<tr bgcolor="#DEE5FA">
